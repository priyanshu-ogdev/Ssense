...
Tests the 4 specific Small Language Model (SLM) structural vulnerabilities:
1. Context-Degradation Attack (Needle In A Haystack - NIAH inside ~20,000 tokens)
2. JSON Schema Fuzzing (Adversarial formatting, chaotic inputs, and syntax corruption)
...
def main():
    ...
    # Wilson 95% CI Lower & Upper bounds
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    print("\n" + "═"*85)
    print("🛡️ ADVERSARIAL SECURITY & SLM VULNERABILITY SCORECARD")
    print("═"*85)
