...
# ═══════════════════════════════════════════════════════════════════════════
def run_dpo():
    print("🚀 PHASE 2: Starting Conversational Chatbot SimPO (Beta=1.0, Gamma=0.5)...")
    ...
    print(f"   vllm serve {BASE_MODEL_PATH} --enable-lora --max-loras 2 --max-lora-rank 64 --lora-modules chatbot={adapter_out}")
...
if __name__ == "__main__":
    ...
    print("\n🏁 FULL INDUSTRIAL CONVERSATIONAL CHATBOT PIPELINE COMPLETED SUCCESSFULLY.")